...
/*!
 * Include guard for rational_number_operators.hpp
 */
...
namespace rational_number
{
    ...
    */    
   [[nodiscard]] RationalNumber operator+(RationalNumber a,RationalNumber b);
   ...
   /*! Stream-insert operator which outputs RationalNumber to output stream.
    */
