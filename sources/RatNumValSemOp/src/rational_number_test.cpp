// rational_number_test.cpp by Ulrich Eisenecker, March 20, 2025
...
TEST_CASE("arithmetic methods","[rational_number]")
{
   ...
   SECTION("add")
   {
      RationalNumber r { a.add(b) };
      REQUIRE(r.numerator() == 6);
      REQUIRE(r.denominator() == 7);
   }
   SECTION("subtract")
   {
      RationalNumber r { a.subtract(b) };
      REQUIRE(r.numerator() == 2);
      REQUIRE(r.denominator() == 7);
   }
   SECTION("multiply")
   {
      RationalNumber r { a.multiply(b) };
      REQUIRE(r.numerator() == 8);
      REQUIRE(r.denominator() == 49);
   }
   SECTION("divide")
   {
      RationalNumber r { a.divide(b) };
      REQUIRE(r.numerator() == 2);
...
TEST_CASE("input","[rational_number]")
{
   ...
   istringstream iss { "(1/2)(-1/2) (1/-2)   (-1/-2) (  2/  4)  (   -2 /   -4)  (0/0)" };
   RationalNumber r;
   // (1/2) --> (1/2)
   r.input(iss);
